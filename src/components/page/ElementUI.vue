        ...
        <div class="form-box">
            <el-form ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="滑块">
                    <el-slider v-model="form.sliderValue" :format-tooltip="formatTooltip"></el-slider>
                </el-form-item>
                <el-form-item label="评分">
                    <el-rate v-model="form.rageValue"  show-text text-color="#ff9900" text-template="{value}"></el-rate>
                </el-form-item>
